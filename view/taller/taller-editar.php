    ...
    <div class="row">
        ...
        <form id="frm-taller-artesano" action="?c=Taller&a=Guardar" method="post" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <span class="obligatorio">* </span><label>Empleos de tiempo completo: </label>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                      <span class="obligatorio">* </span><label>Empleos por horas:</label>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <span class="obligatorio">* </span><label>Empleos registrados en el IMSS:</label>
                        <input type="text" name="empleos-imss" value="<?php #echo $alm->Correo; ?>" class="form-control" placeholder="Ejemplo: 2" data-validacion-tipo="requerido|numero" />
                    </div>
                </div>
            </fieldset>
