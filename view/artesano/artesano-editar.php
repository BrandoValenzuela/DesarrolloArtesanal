...
<div class="container">
  ...
  <div class="row">
    <form id="frm-artesano" action="?c=Artesano&a=Guardar" method="post" enctype="multipart/form-data">
      ...
      <input type="hidden" name="folio" value="<?php echo $artesano->folio; ?>" />
      <fieldset>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" name="grupo-etnico" value="<?php echo $artesano->grupoEtnico; ?>" class="form-control" placeholder="Ingrese el grupo étnico" data-validacion-tipo="" />
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
        ...
        <div class="col-md-2">
          <div class="form-group">
            ...
            <input type="text" name="edad" value="<?php echo $artesano->edad; ?>" class="form-control" placeholder="Ingrese la edad" data-validacion-tipo="requerido|numero|min:2:max:2" />
          </div>
        </div>
        <div class="col-md-2">
          <div class="form-group">
            <label>Tel. Fijo:</label>
            <input type="text" name="telefono-fijo" value="<?php echo $artesano->telefonoFijo; ?>" class="form-control" placeholder="Número telefónico" data-validacion-tipo="numero" />
          </div>
        </div>
        <div class="col-md-2">
          <div class="form-group">
            <label>Tel. Celular:</label>
            <input type="text" name="telefono-cel" value="<?php echo $artesano->telefonoCel; ?>" class="form-control" placeholder="Número telefónico" data-validacion-tipo="numero|min:10:max:10" />
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <span class="obligatorio">* </span><label>Correo electrónico:</label>
            <input type="text" name="email" value="<?php echo $artesano->email; ?>" class="form-control" placeholder="Ingrese un correo" data-validacion-tipo="email" />
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <span class="obligatorio">* </span><label>Facebook:</label>
            <input type="text" name="facebook" value="<?php echo $artesano->facebook; ?>" class="form-control" placeholder="Nombre en Facebook" data-validacion-tipo="" />
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label>Twitter:</label>
            <input type="text" name="twitter" value="<?php echo $artesano->twitter; ?>" class="form-control" placeholder="Nombre en Twitter" data-validacion-tipo="" />
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label>Instagram:</label>
            <input type="text" name="instagram" value="<?php echo $artesano->instagram; ?>" class="form-control" placeholder="Nombre en Instagram" data-validacion-tipo="" />
          </div>
        </div>
      </fieldset><br>
      <fieldset>
        ...
        <div class="col-md-2">
          <div class="form-group">
            ...
            <select name="tipo-actividad" id="tipo-actividad" class="form-control" onclick="habilitarCampoActividadPrimaria()">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="text" name="actividad-primaria" id="actividad-primaria" value="<?php echo $artesano->actividadPrincipal; ?>" class="form-control" placeholder="Ingrese la actividad primaria" disabled="disabled" data-validacion-tipo="" />
          </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
              <span class="obligatorio">* </span><label>¿Cómo aprendió el oficio?</label>
              <select name="aprendizaje-oficio" class="form-control">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <select name="perioricidad" class="form-control">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <select name="pertenencia-taller" id="pertenencia-taller" onclick="muestraFormularioTaller()" class="form-control">
        ...
        <div id="no-pertenece-taller">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select name="lugar-trabajo" id="lugar-trabajo" class="form-control">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select name="prop-lugar-trabajo" id="prop-lugar-trabajo" class="form-control">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select name="tipo-venta" id="tipo-venta" class="form-control">
      ...
      <fieldset>
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" name="cadena-cuis" value="<?php echo $artesano->quiz; ?>" class="form-control" placeholder="Ingrese el CUIS" data-validacion-tipo="" />
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
      ...
      <fieldset>
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea name="necesidades" id="necesidades" cols="30" rows="2" data-validacion-tipo="requerido" placeholder="Ingrese una descripción" class="form-control">
              <?php $texto = trim($artesano->necesidadesPrioritarias); echo $texto; ?>
            </textarea>
          </div>
        </div> 
      </fieldset>
